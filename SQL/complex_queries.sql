-- Explanations for Class Search Query:
...
-- Explanations for Data Visualization Query - 1 (for the time series plot)
...
-- Explanations for Data Visualization Query - 2 (for the pie chart)
...
-- Explanations for Data Visualization Query - 3 (for the top 10 user table)
